...
export function Card({ children, accent, interactive = false, pad = true, accentBar = false, className = '', style = {}, ...rest }: CardProps) {
  ensure()
  ...
  return (
    <div className={cls} style={{ ...(ac ? { '--card-accent': ac } as React.CSSProperties : {}), ...style }} {...rest}>
