...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: P('PTC', 'ptc-7.png'), caption: 'the problem: women majoring in CS fell from 37% in 1984 to 17% in 2023' },
      { src: P('PTC', 'ptc-8.png'), caption: 'our solution: a four-stage site of resources, jobs, events, and mentors' },
