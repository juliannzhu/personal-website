...
const VOLLEYBALL_GALLERY: BentoPhoto[] = [
  { src: Q('volleyball/volleyball-1.webp'), caption: 'Merivale High School Senior Girls Volleyball Team 2025' },
  { src: Q('volleyball/volleyball-2.webp') },
  { src: Q('volleyball/volleyball-3.webp') },
  { src: Q('volleyball/volleyball-4.webp') },
  { src: Q('volleyball/volleyball-5.webp') },
  { src: Q('volleyball/volleyball-6.webp') },
  { src: Q('volleyball/volleyball-7.webp'), caption: 'Team bonding after a beach tournament' },
  { src: Q('volleyball/volleyball-8.webp') },
  { src: Q('volleyball/volleyball-9.webp') },
  { src: Q('volleyball/volleyball-10.webp') },
  { src: Q('volleyball/volleyball-11.webp') },
  { src: Q('volleyball/volleyball-12.webp') },
  { src: Q('volleyball/volleyball-13.webp') },
  { src: Q('volleyball/volleyball-14.webp') },
  { src: Q('volleyball/volleyball-15.webp'), caption: "Waterloo SERVE All Women's Tournament 2026" },
  { src: Q('volleyball/volleyball-16.webp') },
  { src: Q('volleyball/volleyball-17.webp') },
  { src: Q('volleyball/volleyball-18.webp') },
  { src: Q('volleyball/volleyball-19.webp') },
  { src: Q('volleyball/volleyball-20.webp') },
  { src: Q('volleyball/volleyball-21.webp') },
  { src: Q('volleyball/volleyball-22.webp'), caption: 'Last high school game' },
  { src: Q('volleyball/volleyball-23.webp') },
  { src: Q('volleyball/volleyball-24.webp') },
  { src: Q('volleyball/volleyball-25.webp') },
  { src: Q('volleyball/volleyball-26.webp'), caption: 'Beach volleyball in Cuba' },
  { src: Q('volleyball/volleyball-27.webp') },
  { src: Q('volleyball/volleyball-28.webp'), caption: 'Marauders Cup Champions' },
  { src: Q('volleyball/volleyball-29.webp') },
  { src: Q('volleyball/volleyball-30.webp'), caption: '16U Fusion Volleyball Competitive Team' },
  { src: Q('volleyball/volleyball-31.webp') },
  { src: Q('volleyball/volleyball-32.webp') },
  { src: Q('volleyball/volleyball-33.webp') },
  { src: Q('volleyball/volleyball-34.webp'), caption: 'Post win celebration' },
  { src: Q('volleyball/volleyball-35.webp') },
  { src: Q('volleyball/volleyball-36.webp'), caption: 'Marauders Cup 2026 Finalists' },
  { src: Q('volleyball/volleyball-37.webp'), caption: '4x Marauders Cup Champions' },
  { src: Q('volleyball/volleyball-38.webp') },
  { src: Q('volleyball/volleyball-39.webp') },
  { src: Q('volleyball/volleyball-40.webp'), caption: 'STANK 2025' },
  { src: Q('volleyball/volleyball-41.webp') },
  { src: Q('volleyball/volleyball-42.webp') },
  { src: Q('volleyball/volleyball-43.webp') },
  { src: Q('volleyball/volleyball-44.webp'), caption: 'Bomu Volleyball' },
  { src: Q('volleyball/volleyball-45.webp'), caption: 'Waterloo SERVE 3Peas Tournament 2026' },
]
...
const ART_GALLERY: BentoPhoto[] = [
  ...
  { src: Q('art/art-4.webp') },
  { src: Q('art/art-9.webp'), caption: 'Clay crafts after the oven' },
  { src: Q('art/art-5.webp'), caption: 'Chinese New Year whiteboard art' },
  { src: Q('art/art-6.webp') },
  { src: Q('art/art-7.webp') },
  { src: Q('art/art-8.webp'), caption: 'IB art technique practice' },
  { src: Q('art/art-10.webp') },
  { src: Q('art/art-11.webp') },
  { src: Q('art/art-12.webp') },
  { src: Q('art/art-14.webp') },
  { src: Q('art/art-15.webp'), caption: "Valentine's Day paper bouquet" },
  { src: Q('art/art-16.webp'), caption: 'Painting tote bags in Waterloo' },
  { src: Q('art/art-17.webp') },
  { src: Q('art/art-18.webp') },
  { src: Q('art/art-19.webp'), caption: 'Homemade stamps for Halloween 2025' },
  { src: Q('art/art-20.webp'), caption: '3D wooden puzzle piano build' },
  { src: Q('art/art-21.webp') },
  { src: Q('art/art-22.webp') },
  { src: Q('art/art-23.webp') },
  { src: Q('art/art-24.webp') },
  { src: Q('art/art-26.webp') },
  { src: Q('art/art-27.webp'), caption: 'Paint by number' },
  { src: Q('art/art-28.webp') },
  { src: Q('art/art-29.webp') },
  { src: Q('art/art-30.webp') },
  { src: Q('art/art-31.webp') },
  { src: Q('art/art-32.webp'), caption: 'Picasso study' },
  { src: Q('art/art-33.webp'), caption: 'Starry Night study' },
  { src: Q('art/art-34.webp') },
  { src: Q('art/art-35.webp') },
  { src: Q('art/art-36.webp') },
...
const BAKING_GALLERY: BentoPhoto[] = [
  { src: Q('baking/baking-2.webp') },
  { src: Q('baking/baking-3.webp'), caption: 'Canada Day Brunch' },
  { src: Q('baking/baking-4.webp'), caption: 'Post strawberry picking meal' },
  { src: Q('baking/baking-8.webp'), caption: 'Baking cookies at Waterloo' },
  { src: Q('baking/baking-9.webp'), caption: 'Embroidery crafts and cookies' },
  { src: Q('baking/baking-5.webp') },
  { src: Q('baking/baking-15.webp'), caption: 'Balsamic salad' },
  { src: Q('baking/baking-7.webp') },
  { src: Q('baking/baking-1.webp') },
  { src: Q('baking/baking-6.webp') },
  { src: Q('baking/baking-10.webp'), caption: 'Strawberry cheesecake' },
  { src: Q('baking/baking-11.webp') },
  { src: Q('baking/baking-12.webp'), caption: 'Bruschetta spread' },
  { src: Q('baking/baking-13.webp') },
  { src: Q('baking/baking-14.webp') },
  { src: Q('baking/baking-16.webp'), caption: 'Abura soba' },
  { src: Q('baking/baking-17.webp'), caption: 'Homemade avocado toast' },
  { src: Q('baking/baking-18.webp'), caption: 'Bruschetta close up' },
  { src: Q('baking/baking-19.webp'), caption: 'Prosciutto' },
  { src: Q('baking/baking-20.webp'), caption: 'Zucchini egg bites' },
]

const MODELLING_GALLERY: BentoPhoto[] = [
  { src: Q('modelling/modelling-1.webp'), caption: "Birthday photoshoot in China 2025" },
  { src: Q('modelling/modelling-15.webp') },
  { src: Q('modelling/modelling-32.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-81.webp') },
  { src: Q('modelling/modelling-65.webp') },
  { src: Q('modelling/modelling-43.webp') },
  { src: Q('modelling/modelling-70.webp') },
  { src: Q('modelling/modelling-51.webp') },
  { src: Q('modelling/modelling-77.webp') },
  { src: Q('modelling/modelling-2.webp') },
  { src: Q('modelling/modelling-17.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-59.webp') },
  { src: Q('modelling/modelling-30.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-79.webp') },
  { src: Q('modelling/modelling-29.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-80.webp') },
  { src: Q('modelling/modelling-83.webp') },
  { src: Q('modelling/modelling-8.webp') },
  { src: Q('modelling/modelling-47.webp') },
  { src: Q('modelling/modelling-46.webp') },
  { src: Q('modelling/modelling-25.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-52.webp') },
  { src: Q('modelling/modelling-6.webp') },
  { src: Q('modelling/modelling-82.webp') },
  { src: Q('modelling/modelling-64.webp') },
  { src: Q('modelling/modelling-18.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-76.webp') },
  { src: Q('modelling/modelling-69.webp') },
  { src: Q('modelling/modelling-78.webp') },
  { src: Q('modelling/modelling-19.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-10.webp') },
  { src: Q('modelling/modelling-75.webp'), caption: "Japan House in Illinois" },
  { src: Q('modelling/modelling-34.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-57.webp') },
  { src: Q('modelling/modelling-40.webp') },
  { src: Q('modelling/modelling-26.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-20.webp'), caption: "Fashion for Change Photoshoot 2025 · 📸 @dr.k.bear" },
  { src: Q('modelling/modelling-55.webp') },
  { src: Q('modelling/modelling-35.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-45.webp') },
  { src: Q('modelling/modelling-63.webp') },
  { src: Q('modelling/modelling-7.webp') },
  { src: Q('modelling/modelling-72.webp') },
  { src: Q('modelling/modelling-3.webp') },
  { src: Q('modelling/modelling-31.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-33.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-50.webp'), caption: "The Louvre in Paris" },
  { src: Q('modelling/modelling-14.webp') },
  { src: Q('modelling/modelling-11.webp') },
  { src: Q('modelling/modelling-73.webp') },
  { src: Q('modelling/modelling-71.webp') },
  { src: Q('modelling/modelling-67.webp'), caption: '📸 @alexanderjacobiphotography' },
  { src: Q('modelling/modelling-58.webp') },
  { src: Q('modelling/modelling-28.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-61.webp') },
  { src: Q('modelling/modelling-42.webp') },
  { src: Q('modelling/modelling-5.webp') },
  { src: Q('modelling/modelling-66.webp') },
  { src: Q('modelling/modelling-36.webp'), caption: "Recreating poses in Paris" },
  { src: Q('modelling/modelling-22.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-24.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-60.webp'), caption: "China photoshoot makeup" },
  { src: Q('modelling/modelling-27.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-48.webp') },
  { src: Q('modelling/modelling-21.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-68.webp') },
  { src: Q('modelling/modelling-41.webp') },
  { src: Q('modelling/modelling-23.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-56.webp') },
  { src: Q('modelling/modelling-12.webp') },
  { src: Q('modelling/modelling-54.webp') },
  { src: Q('modelling/modelling-4.webp') },
  { src: Q('modelling/modelling-9.webp') },
  { src: Q('modelling/modelling-16.webp'), caption: '📸 @dr.k.bear' },
  { src: Q('modelling/modelling-13.webp') },
  { src: Q('modelling/modelling-49.webp'), caption: "Prom photoshoot" },
  { src: Q('modelling/modelling-74.webp') },
]


const ROBOTICS_GALLERY: BentoPhoto[] = [
  { src: Q('robotics/robotics-1.webp'), caption: "DCMP 2025" },
  { src: Q('robotics/robotics-2.webp') },
  { src: Q('robotics/robotics-3.webp'), caption: "Garage sale sign for good luck" },
  { src: Q('robotics/robotics-4.webp') },
  { src: Q('robotics/robotics-5.webp'), caption: "Cheering on 8729" },
  { src: Q('robotics/robotics-6.webp') },
  { src: Q('robotics/robotics-7.webp'), caption: "Spark Youth Robotics pins" },
  { src: Q('robotics/robotics-8.webp') },
  { src: Q('robotics/robotics-9.webp'), caption: "Built the coral reef game pieces" },
  { src: Q('robotics/robotics-12.webp') },
  { src: Q('robotics/robotics-14.webp') },
  { src: Q('robotics/robotics-15.webp') },
  { src: Q('robotics/robotics-16.webp') },
  { src: Q('robotics/robotics-17.webp') },
  { src: Q('robotics/robotics-18.webp') },
  { src: Q('robotics/robotics-19.webp') },
  { src: Q('robotics/robotics-20.webp') },
  { src: Q('robotics/robotics-22.webp') },
  { src: Q('robotics/robotics-23.webp') },
  { src: Q('robotics/robotics-24.webp') },
  { src: Q('robotics/robotics-21.webp'), caption: "KCSSC Demo 2024" },
  { src: Q('robotics/robotics-11.webp') },
  { src: Q('robotics/robotics-13.webp') },
  { src: Q('robotics/robotics-10.webp') },
]

const LEGO_GALLERY: BentoPhoto[] = [
  { src: Q('lego/lego-1.webp') },
  { src: Q('lego/lego-2.webp') },
  { src: Q('lego/lego-3.webp') },
  { src: Q('lego/lego-4.webp') },
  { src: Q('lego/lego-5.webp') },
  { src: Q('lego/lego-6.webp'), caption: 'Hard at work building' },
  { src: Q('lego/lego-7.webp'), caption: 'Final Presentations' },
  { src: Q('lego/lego-8.webp'), caption: 'Our team' },
  { src: Q('lego/lego-9.webp') },
  { src: Q('lego/lego-10.webp') },
  { src: Q('lego/lego-11.webp') },
]

const PIANO_GALLERY: BentoPhoto[] = [
  { src: Q('piano/piano-2.webp'), caption: 'Performing at Taikang retirement center' },
  { src: Q('piano/piano-1.webp') },
  { src: Q('piano/piano-3.webp') },
  { src: Q('piano/piano-4.webp'), caption: 'Oscar Peterson statue in Ottawa' },
  { src: Q('piano/piano-5.webp'), caption: 'Piano before prom' },
]

const POOL_GALLERY: BentoPhoto[] = [
  { src: Q('pool/pool-6.webp') },
  { src: Q('pool/pool-1.webp'), caption: 'Teamwork' },
  { src: Q('pool/pool-2.webp') },
  { src: Q('pool/pool-7.webp') },
  { src: Q('pool/pool-3.webp') },
  { src: Q('pool/pool-4.webp') },
  { src: Q('pool/pool-5.webp') },
  { src: Q('pool/pool-8.webp') },
]
...
const QUESTS: QuestCard[] = [
  ...
  },
  {
    ...
    videos: videosFor('piano', [1, 8, 3, 4, 5, 6, 7, 9, 10, 11, 12, 13], {
  ...
  },
  {
    ...
    placeholder: '🍽️',
    images: [Q('baking/baking-3.webp')],
    cover: Q('baking/baking-10.webp'),
    layout: 'bento',
  ...
  },
  {
    ...
    placeholder: '✈️',
    images: Array.from({ length: 124 }, (_, i) => Q(`travel/travel-${i + 1}.webp`)),
    cover: Q('travel/travel-111.webp'),
    layout: 'marquee',
  ...
  },
  {
    ...
    placeholder: '♠️',
    images: [Q('poker/poker-1.webp'), Q('poker/poker-3.webp'), Q('poker/poker-4.webp'), Q('poker/poker-5.webp'), Q('poker/poker-7.webp')],
    cover: Q('poker/poker-6.webp'),
    layout: 'bento',
    gallery: [
      { src: Q('poker/poker-6.webp'), caption: 'I was the pocket 10s' },
      { src: Q('poker/poker-8.webp'), caption: 'University of Waterloo Poker Studies Club tournament' },
      { src: Q('poker/poker-2.webp') },
      { src: Q('poker/poker-1.webp') },
      { src: Q('poker/poker-3.webp') },
      { src: Q('poker/poker-4.webp'), caption: 'Sequence Holdings Poker Tournament' },
      { src: Q('poker/poker-5.webp') },
      { src: Q('poker/poker-7.webp'), caption: 'a huge run at Waterloo' },
    ],
  ...
  },
  {
    ...
    placeholder: '📷',
    images: Array.from({ length: 42 }, (_, i) => Q(`photography/photography-${i + 1}.webp`)),
    cover: Q('photography/photography-17.webp'),
    layout: 'marquee',
    marqueeHeight: 'calc(100vh - 260px)',
  },
  {
    ...
    images: Array.from({ length: 55 }, (_, i) => i + 1)
      ...
      .map((n) => Q(`shad/shad-${n}.webp`)),
    cover: Q('shad/shad-7.webp'),
    layout: 'polaroid',
  ...
  },
  {
    ...
    placeholder: '🎗️',
    images: Array.from({ length: 6 }, (_, i) => Q(`relay/relay-${[2, 3, 5, 6, 7, 9][i]}.webp`)),
    cover: Q('relay/relay-4.webp'),
    layout: 'bento',
    gallery: [
      { src: Q('relay/relay-1.webp'), caption: 'Bake sale fundraiser' },
      { src: Q('relay/relay-4.webp'), caption: 'Merivale Relay for Life Event 2024' },
      { src: Q('relay/relay-8.webp') },
      { src: Q('relay/relay-2.webp') },
      { src: Q('relay/relay-3.webp') },
      { src: Q('relay/relay-5.webp') },
      { src: Q('relay/relay-6.webp') },
      { src: Q('relay/relay-7.webp') },
      { src: Q('relay/relay-9.webp') },
    ],
  },
  {
    id: 'lego',
